...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_irq_mapper.vho"                                                                        -work irq_mapper                                                                       
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_rsp_xbar_mux.vho"                                                                      -work rsp_xbar_mux                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_rsp_xbar_demux.vho"                                                                    -work rsp_xbar_demux                                                                   
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_cmd_xbar_mux.vho"                                                                      -work cmd_xbar_mux                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_cmd_xbar_demux.vho"                                                                    -work cmd_xbar_demux                                                                   
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_id_router.vho"                                                                         -work id_router                                                                        
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_addr_router.vho"                                                                       -work addr_router                                                                      
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo.vho" -work nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/regfile.vhd"                                                                                     -work reg_0                                                                            
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_onchip_memory2_0.vhd"                                                                  -work onchip_memory2_0                                                                 
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0.vho"                                                                      -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_jtag_debug_module_sysclk.vhd"                                             -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_jtag_debug_module_tck.vhd"                                                -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_jtag_debug_module_wrapper.vhd"                                            -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_mult_cell.vhd"                                                            -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_oci_test_bench.vhd"                                                       -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/submodules/nios_test_nios2_qsys_0_test_bench.vhd"                                                           -work nios2_qsys_0                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/nios_test.vhd"                                                                                                                                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/nios_test_nios2_qsys_0_jtag_debug_module_translator.vhd"                                                                                                                                           
  vhdlan -xlrm "$QSYS_SIMDIR/nios_test_onchip_memory2_0_s1_translator.vhd"                                                                                                                                                      
  vhdlan -xlrm "$QSYS_SIMDIR/nios_test_reg_0_avalon_slave_0_translator.vhd"                                                                                                                                                     
  vhdlan -xlrm "$QSYS_SIMDIR/nios_test_nios2_qsys_0_instruction_master_translator.vhd"                                                                                                                                          
  vhdlan -xlrm "$QSYS_SIMDIR/nios_test_nios2_qsys_0_data_master_translator.vhd"                                                                                                                                                 
fi
