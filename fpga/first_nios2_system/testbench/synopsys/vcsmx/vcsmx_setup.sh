...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_rsp_xbar_demux_001.vho"                                                             -work rsp_xbar_demux_001                                                            
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_cmd_xbar_mux_001.vho"                                                               -work cmd_xbar_mux_001                                                              
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_id_router_001.vho"                                                                  -work id_router_001                                                                 
