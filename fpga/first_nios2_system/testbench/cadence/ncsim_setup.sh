...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_rst_controller.vhd"                                                                 -work first_nios2_system_inst                                                        -cdslib ./cds_libs/first_nios2_system_inst.cds.lib                                                       
  ncvhdl -v93 "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_rst_controller_001.vhd"                                                             -work first_nios2_system_inst                                                        -cdslib ./cds_libs/first_nios2_system_inst.cds.lib                                                       
