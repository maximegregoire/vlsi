...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_led_pio.vhd"                                                                  -work led_pio                                                                  -cdslib ./cds_libs/led_pio.cds.lib                                                                 
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/first_nios2_system_led_pio_s1_translator.vhd"                                                    -work first_nios2_system_inst                                                  -cdslib ./cds_libs/first_nios2_system_inst.cds.lib                                                 
