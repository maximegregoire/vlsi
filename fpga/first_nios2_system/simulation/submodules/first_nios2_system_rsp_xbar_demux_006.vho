...
--synthesis_resources = 
 ...
 ENTITY  first_nios2_system_rsp_xbar_demux_006 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END first_nios2_system_rsp_xbar_demux_006;

 ARCHITECTURE RTL OF first_nios2_system_rsp_xbar_demux_006 IS
 ...
 END RTL; --first_nios2_system_rsp_xbar_demux_006
