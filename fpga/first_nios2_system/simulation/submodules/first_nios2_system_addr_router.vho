...
--synthesis_resources = mux21 32 
 ...
 BEGIN
	...
	wire_w2w(0) <= NOT s_wire_first_nios2_system_addr_router_src_channel_1_314_dataout;
	...
	s_wire_first_nios2_system_addr_router_src_channel_2_335_dataout <= ((((((((((((((sink_data(41) AND sink_data(42)) AND (NOT sink_data(43))) AND (NOT sink_data(44))) AND (NOT sink_data(45))) AND (NOT sink_data(46))) AND (NOT sink_data(47))) AND (NOT sink_data(48))) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND (NOT sink_data(52))) AND (NOT sink_data(53))) AND (NOT sink_data(54))) AND (NOT sink_data(55)));
	s_wire_first_nios2_system_addr_router_src_channel_3_356_dataout <= (((((((((((((((((NOT sink_data(39)) AND (NOT sink_data(40))) AND (NOT sink_data(41))) AND (NOT sink_data(42))) AND sink_data(43)) AND (NOT sink_data(44))) AND (NOT sink_data(45))) AND (NOT sink_data(46))) AND (NOT sink_data(47))) AND (NOT sink_data(48))) AND (NOT sink_data(49))) AND (NOT sink_data(50))) AND (NOT sink_data(51))) AND (NOT sink_data(52))) AND (NOT sink_data(53))) AND (NOT sink_data(54))) AND (NOT sink_data(55)));
	...
	wire_first_nios2_system_addr_router_src_data_21m_dataout <= s_wire_first_nios2_system_addr_router_src_channel_0_293_dataout OR s_wire_first_nios2_system_addr_router_src_channel_1_314_dataout;
	wire_first_nios2_system_addr_router_src_data_30m_dataout <= wire_w2w(0) AND NOT(s_wire_first_nios2_system_addr_router_src_channel_2_335_dataout);
	wire_first_nios2_system_addr_router_src_data_31m_dataout <= wire_first_nios2_system_addr_router_src_data_21m_dataout AND NOT(s_wire_first_nios2_system_addr_router_src_channel_2_335_dataout);
	wire_first_nios2_system_addr_router_src_data_39m_dataout <= s_wire_first_nios2_system_addr_router_src_channel_2_335_dataout OR s_wire_first_nios2_system_addr_router_src_channel_3_356_dataout;
	...
	wire_first_nios2_system_addr_router_src_data_61m_dataout <= wire_first_nios2_system_addr_router_src_data_51m_dataout AND NOT(s_wire_first_nios2_system_addr_router_src_channel_5_398_dataout);
