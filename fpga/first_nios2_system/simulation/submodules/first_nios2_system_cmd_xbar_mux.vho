...
--synthesis_resources = lut 9 mux21 12 oper_add 1 
 ...
 ARCHITECTURE RTL OF first_nios2_system_cmd_xbar_mux IS

	 ATTRIBUTE synthesis_clearbox : natural;
	 ATTRIBUTE synthesis_clearbox OF RTL : ARCHITECTURE IS 1;
	 SIGNAL	first_nios2_system_cmd_xbar_mux_saved_grant_0_32q	:	STD_LOGIC := '0';
	 SIGNAL	first_nios2_system_cmd_xbar_mux_saved_grant_1_31q	:	STD_LOGIC := '0';
	 ...
	 SIGNAL	first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q	:	STD_LOGIC := '0';
	 SIGNAL	first_nios2_system_cmd_xbar_mux_share_count_zero_flag_30q	:	STD_LOGIC := '0';
	 SIGNAL	first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q	:	STD_LOGIC := '0';
	 ...
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_790m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_791m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_792m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_793m_dataout	:	STD_LOGIC;
	 ...
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_packet_in_progress_9m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_share_count_17m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_share_count_19m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_share_count_zero_flag_18m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_share_count_zero_flag_20m_dataout	:	STD_LOGIC;
	 SIGNAL	wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout	:	STD_LOGIC;
	 SIGNAL  wire_first_nios2_system_cmd_xbar_mux_add0_13_a	:	STD_LOGIC_VECTOR (1 DOWNTO 0);
	 SIGNAL  wire_first_nios2_system_cmd_xbar_mux_add0_13_b	:	STD_LOGIC_VECTOR (1 DOWNTO 0);
	 ...
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_819_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_816_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_821_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_787_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_788_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_789_dataout :	STD_LOGIC;
	 ...
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_src_payload_0_281_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_src_payload_115_dataout :	STD_LOGIC;
	 SIGNAL  s_wire_first_nios2_system_cmd_xbar_mux_src_payload_235_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	wire_gnd <= '0';
	wire_w_lg_w4w5w(0) <= wire_w4w(0) AND s_wire_first_nios2_system_cmd_xbar_mux_src_payload_0_281_dataout;
	wire_w_lg_w746w755w(0) <= wire_w746w(0) AND s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_821_dataout;
	wire_w_lg_w754w762w(0) <= wire_w754w(0) AND first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q;
	wire_w748w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_request_0_33_dataout AND wire_w_lg_w746w747w(0);
	wire_w750w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_request_0_33_dataout AND wire_w_lg_w746w749w(0);
	wire_w757w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_request_1_34_dataout AND wire_w_lg_w754w756w(0);
	wire_w753w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_request_1_34_dataout AND wire_w752w(0);
	wire_w4w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_wideor1_40_dataout AND src_ready;
	wire_w_lg_reset3w(0) <= NOT reset;
	wire_w746w(0) <= NOT s_wire_first_nios2_system_cmd_xbar_mux_request_0_33_dataout;
	wire_w754w(0) <= NOT s_wire_first_nios2_system_cmd_xbar_mux_request_1_34_dataout;
	wire_w23w(0) <= NOT s_wire_first_nios2_system_cmd_xbar_mux_wideor1_40_dataout;
	wire_w6w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_src_payload_115_dataout OR s_wire_first_nios2_system_cmd_xbar_mux_src_payload_235_dataout;
	wire_w_lg_w746w747w(0) <= wire_w746w(0) XOR first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q;
	wire_w_lg_w746w749w(0) <= wire_w746w(0) XOR s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_821_dataout;
	wire_w_lg_w754w756w(0) <= wire_w754w(0) XOR wire_w_lg_w746w755w(0);
	wire_w752w(0) <= s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_816_dataout XOR s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_819_dataout;
	s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_819_dataout <= (wire_w754w(0) XOR first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q);
	s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_816_dataout <= (wire_w746w(0) AND first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q);
	s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_1_821_dataout <= (wire_w_lg_w754w762w(0) OR (s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_full_adder_cout_0_816_dataout AND s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_altera_merlin_arb_adder_adder_cout_819_dataout));
	s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_787_dataout <= (wire_w748w(0) OR wire_w750w(0));
	s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_788_dataout <= (wire_w753w(0) OR wire_w757w(0));
	s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_789_dataout <= (s_wire_first_nios2_system_cmd_xbar_mux_request_0_33_dataout OR s_wire_first_nios2_system_cmd_xbar_mux_request_1_34_dataout);
	...
	s_wire_first_nios2_system_cmd_xbar_mux_src_payload_0_281_dataout <= ((first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND sink0_endofpacket) OR (first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND sink1_endofpacket));
	s_wire_first_nios2_system_cmd_xbar_mux_src_payload_115_dataout <= (first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND sink0_data(72));
	s_wire_first_nios2_system_cmd_xbar_mux_src_payload_235_dataout <= (first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND sink1_data(72));
 ...
 & wire_ni_w_lg_w208w211w & wire_ni_w_lg_w202w205w & wire_ni_w_lg_w196w199w & wire_ni_w_lg_w190w193w & wire_ni_w_lg_w184w187w & wire_ni_w_lg_w178w181w & wire_ni_w_lg_w172w175w & wire_ni_w_lg_w166w169w & wire_ni_w_lg_w160w163w & wire_ni_w_lg_w154w157w & wire_ni_w_lg_w148w151w & wire_ni_w_lg_w142w145w & wire_ni_w_lg_w136w139w & wire_ni_w_lg_w130w133w & wire_ni_w_lg_w124w127w & wire_ni_w_lg_w118w121w & wire_ni_w_lg_w112w115w & wire_ni_w_lg_w106w109w & wire_ni_w_lg_w100w103w & wire_ni_w_lg_w94w97w & wire_ni_w_lg_w88w91w & wire_ni_w_lg_w82w85w & wire_ni_w_lg_w76w79w & wire_ni_w_lg_w70w73w & wire_ni_w_lg_w64w67w & wire_ni_w_lg_w58w61w & wire_ni_w_lg_w52w55w & wire_ni_w_lg_w46w49w & wire_ni_w_lg_w39w42w);
	...
	BEGIN
		IF (reset = '1') THEN
				first_nios2_system_cmd_xbar_mux_saved_grant_0_32q <= '0';
		...
		ELSIF (clk = '1' AND clk'event) THEN
			IF (wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout = '1') THEN
				first_nios2_system_cmd_xbar_mux_saved_grant_0_32q <= s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_787_dataout;
				first_nios2_system_cmd_xbar_mux_saved_grant_1_31q <= s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_788_dataout;
			END IF;
		END IF;
	END PROCESS;
	wire_ni_w701w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range700w(0);
	wire_ni_w708w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range707w(0);
	wire_ni_w714w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range713w(0);
	wire_ni_w720w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range719w(0);
	wire_ni_w726w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range725w(0);
	wire_ni_w732w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range731w(0);
	wire_ni_w738w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_channel_range737w(0);
	wire_ni_w39w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range38w(0);
	wire_ni_w635w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range634w(0);
	wire_ni_w641w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range640w(0);
	wire_ni_w647w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range646w(0);
	wire_ni_w653w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range652w(0);
	wire_ni_w659w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range658w(0);
	wire_ni_w665w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range664w(0);
	wire_ni_w671w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range670w(0);
	wire_ni_w677w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range676w(0);
	wire_ni_w683w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range682w(0);
	wire_ni_w689w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range688w(0);
	wire_ni_w100w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range99w(0);
	wire_ni_w695w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range694w(0);
	wire_ni_w106w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range105w(0);
	wire_ni_w112w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range111w(0);
	wire_ni_w118w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range117w(0);
	wire_ni_w124w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range123w(0);
	wire_ni_w130w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range129w(0);
	wire_ni_w136w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range135w(0);
	wire_ni_w142w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range141w(0);
	wire_ni_w148w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range147w(0);
	wire_ni_w154w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range153w(0);
	wire_ni_w46w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range45w(0);
	wire_ni_w160w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range159w(0);
	wire_ni_w166w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range165w(0);
	wire_ni_w172w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range171w(0);
	wire_ni_w178w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range177w(0);
	wire_ni_w184w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range183w(0);
	wire_ni_w190w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range189w(0);
	wire_ni_w196w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range195w(0);
	wire_ni_w202w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range201w(0);
	wire_ni_w208w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range207w(0);
	wire_ni_w214w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range213w(0);
	wire_ni_w52w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range51w(0);
	wire_ni_w220w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range219w(0);
	wire_ni_w226w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range225w(0);
	wire_ni_w232w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range231w(0);
	wire_ni_w238w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range237w(0);
	wire_ni_w244w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range243w(0);
	wire_ni_w250w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range249w(0);
	wire_ni_w256w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range255w(0);
	wire_ni_w262w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range261w(0);
	wire_ni_w268w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range267w(0);
	wire_ni_w274w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range273w(0);
	wire_ni_w58w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range57w(0);
	wire_ni_w280w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range279w(0);
	wire_ni_w286w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range285w(0);
	wire_ni_w292w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range291w(0);
	wire_ni_w298w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range297w(0);
	wire_ni_w304w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range303w(0);
	wire_ni_w310w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range309w(0);
	wire_ni_w316w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range315w(0);
	wire_ni_w322w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range321w(0);
	wire_ni_w328w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range327w(0);
	wire_ni_w334w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range333w(0);
	wire_ni_w64w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range63w(0);
	wire_ni_w340w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range339w(0);
	wire_ni_w346w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range345w(0);
	wire_ni_w352w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range351w(0);
	wire_ni_w358w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range357w(0);
	wire_ni_w364w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range363w(0);
	wire_ni_w370w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range369w(0);
	wire_ni_w376w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range375w(0);
	wire_ni_w382w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range381w(0);
	wire_ni_w388w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range387w(0);
	wire_ni_w394w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range393w(0);
	wire_ni_w70w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range69w(0);
	wire_ni_w400w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range399w(0);
	wire_ni_w406w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range405w(0);
	wire_ni_w412w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range411w(0);
	wire_ni_w418w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range417w(0);
	wire_ni_w424w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range423w(0);
	wire_ni_w430w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range429w(0);
	wire_ni_w436w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range435w(0);
	wire_ni_w442w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range441w(0);
	wire_ni_w448w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range447w(0);
	wire_ni_w454w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range453w(0);
	wire_ni_w76w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range75w(0);
	wire_ni_w460w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range459w(0);
	wire_ni_w466w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range465w(0);
	wire_ni_w473w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range472w(0);
	wire_ni_w479w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range478w(0);
	wire_ni_w485w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range484w(0);
	wire_ni_w491w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range490w(0);
	wire_ni_w497w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range496w(0);
	wire_ni_w503w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range502w(0);
	wire_ni_w509w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range508w(0);
	wire_ni_w82w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range81w(0);
	wire_ni_w515w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range514w(0);
	wire_ni_w521w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range520w(0);
	wire_ni_w527w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range526w(0);
	wire_ni_w533w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range532w(0);
	wire_ni_w539w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range538w(0);
	wire_ni_w545w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range544w(0);
	wire_ni_w551w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range550w(0);
	wire_ni_w557w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range556w(0);
	wire_ni_w563w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range562w(0);
	wire_ni_w569w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range568w(0);
	wire_ni_w88w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range87w(0);
	wire_ni_w575w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range574w(0);
	wire_ni_w581w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range580w(0);
	wire_ni_w587w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range586w(0);
	wire_ni_w593w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range592w(0);
	wire_ni_w599w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range598w(0);
	wire_ni_w605w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range604w(0);
	wire_ni_w611w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range610w(0);
	wire_ni_w617w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range616w(0);
	wire_ni_w623w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range622w(0);
	wire_ni_w629w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range628w(0);
	wire_ni_w94w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_0_32q AND wire_w_sink0_data_range93w(0);
	wire_ni_w703w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range702w(0);
	wire_ni_w710w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range709w(0);
	wire_ni_w716w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range715w(0);
	wire_ni_w722w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range721w(0);
	wire_ni_w728w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range727w(0);
	wire_ni_w734w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range733w(0);
	wire_ni_w740w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_channel_range739w(0);
	wire_ni_w41w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range40w(0);
	wire_ni_w637w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range636w(0);
	wire_ni_w643w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range642w(0);
	wire_ni_w649w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range648w(0);
	wire_ni_w655w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range654w(0);
	wire_ni_w661w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range660w(0);
	wire_ni_w667w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range666w(0);
	wire_ni_w673w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range672w(0);
	wire_ni_w679w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range678w(0);
	wire_ni_w685w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range684w(0);
	wire_ni_w691w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range690w(0);
	wire_ni_w102w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range101w(0);
	wire_ni_w697w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range696w(0);
	wire_ni_w108w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range107w(0);
	wire_ni_w114w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range113w(0);
	wire_ni_w120w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range119w(0);
	wire_ni_w126w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range125w(0);
	wire_ni_w132w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range131w(0);
	wire_ni_w138w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range137w(0);
	wire_ni_w144w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range143w(0);
	wire_ni_w150w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range149w(0);
	wire_ni_w156w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range155w(0);
	wire_ni_w48w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range47w(0);
	wire_ni_w162w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range161w(0);
	wire_ni_w168w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range167w(0);
	wire_ni_w174w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range173w(0);
	wire_ni_w180w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range179w(0);
	wire_ni_w186w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range185w(0);
	wire_ni_w192w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range191w(0);
	wire_ni_w198w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range197w(0);
	wire_ni_w204w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range203w(0);
	wire_ni_w210w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range209w(0);
	wire_ni_w216w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range215w(0);
	wire_ni_w54w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range53w(0);
	wire_ni_w222w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range221w(0);
	wire_ni_w228w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range227w(0);
	wire_ni_w234w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range233w(0);
	wire_ni_w240w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range239w(0);
	wire_ni_w246w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range245w(0);
	wire_ni_w252w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range251w(0);
	wire_ni_w258w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range257w(0);
	wire_ni_w264w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range263w(0);
	wire_ni_w270w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range269w(0);
	wire_ni_w276w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range275w(0);
	wire_ni_w60w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range59w(0);
	wire_ni_w282w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range281w(0);
	wire_ni_w288w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range287w(0);
	wire_ni_w294w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range293w(0);
	wire_ni_w300w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range299w(0);
	wire_ni_w306w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range305w(0);
	wire_ni_w312w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range311w(0);
	wire_ni_w318w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range317w(0);
	wire_ni_w324w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range323w(0);
	wire_ni_w330w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range329w(0);
	wire_ni_w336w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range335w(0);
	wire_ni_w66w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range65w(0);
	wire_ni_w342w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range341w(0);
	wire_ni_w348w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range347w(0);
	wire_ni_w354w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range353w(0);
	wire_ni_w360w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range359w(0);
	wire_ni_w366w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range365w(0);
	wire_ni_w372w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range371w(0);
	wire_ni_w378w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range377w(0);
	wire_ni_w384w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range383w(0);
	wire_ni_w390w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range389w(0);
	wire_ni_w396w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range395w(0);
	wire_ni_w72w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range71w(0);
	wire_ni_w402w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range401w(0);
	wire_ni_w408w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range407w(0);
	wire_ni_w414w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range413w(0);
	wire_ni_w420w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range419w(0);
	wire_ni_w426w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range425w(0);
	wire_ni_w432w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range431w(0);
	wire_ni_w438w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range437w(0);
	wire_ni_w444w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range443w(0);
	wire_ni_w450w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range449w(0);
	wire_ni_w456w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range455w(0);
	wire_ni_w78w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range77w(0);
	wire_ni_w462w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range461w(0);
	wire_ni_w468w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range467w(0);
	wire_ni_w475w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range474w(0);
	wire_ni_w481w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range480w(0);
	wire_ni_w487w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range486w(0);
	wire_ni_w493w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range492w(0);
	wire_ni_w499w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range498w(0);
	wire_ni_w505w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range504w(0);
	wire_ni_w511w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range510w(0);
	wire_ni_w84w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range83w(0);
	wire_ni_w517w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range516w(0);
	wire_ni_w523w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range522w(0);
	wire_ni_w529w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range528w(0);
	wire_ni_w535w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range534w(0);
	wire_ni_w541w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range540w(0);
	wire_ni_w547w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range546w(0);
	wire_ni_w553w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range552w(0);
	wire_ni_w559w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range558w(0);
	wire_ni_w565w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range564w(0);
	wire_ni_w571w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range570w(0);
	wire_ni_w90w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range89w(0);
	wire_ni_w577w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range576w(0);
	wire_ni_w583w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range582w(0);
	wire_ni_w589w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range588w(0);
	wire_ni_w595w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range594w(0);
	wire_ni_w601w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range600w(0);
	wire_ni_w607w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range606w(0);
	wire_ni_w613w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range612w(0);
	wire_ni_w619w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range618w(0);
	wire_ni_w625w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range624w(0);
	wire_ni_w631w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range630w(0);
	wire_ni_w96w(0) <= first_nios2_system_cmd_xbar_mux_saved_grant_1_31q AND wire_w_sink1_data_range95w(0);
	...
	BEGIN
		IF (reset = '1') THEN
				first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q <= '1';
				first_nios2_system_cmd_xbar_mux_share_count_zero_flag_30q <= '1';
		ELSIF (clk = '1' AND clk'event) THEN
				first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q <= wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_793m_dataout;
	...
	BEGIN
		IF (reset = '1') THEN
				first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q <= '0';
		...
		ELSIF (clk = '1' AND clk'event) THEN
				first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q <= wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_792m_dataout;
				first_nios2_system_cmd_xbar_mux_locked_0_11q <= (sink0_data(72) AND s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_787_dataout);
				first_nios2_system_cmd_xbar_mux_locked_1_3q <= (sink1_data(72) AND s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_788_dataout);
	...
	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_790m_dataout <= s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_0_787_dataout WHEN s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_789_dataout = '1'  ELSE first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q;
	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_791m_dataout <= s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_grant_1_788_dataout WHEN s_wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_wideor0_789_dataout = '1'  ELSE first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q;
	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_792m_dataout <= wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_790m_dataout WHEN wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout = '1'  ELSE first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_1_795q;
	wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_793m_dataout <= wire_first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_791m_dataout WHEN wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout = '1'  ELSE first_nios2_system_cmd_xbar_mux_altera_merlin_arbitrator_arb_top_priority_reg_0_796q;
	...
	wire_first_nios2_system_cmd_xbar_mux_packet_in_progress_9m_dataout <= first_nios2_system_cmd_xbar_mux_packet_in_progress_21q OR s_wire_first_nios2_system_cmd_xbar_mux_wideor1_40_dataout;
	wire_first_nios2_system_cmd_xbar_mux_share_count_17m_dataout <= wire_first_nios2_system_cmd_xbar_mux_p1_share_count_0_14m_dataout WHEN s_wire_first_nios2_system_cmd_xbar_mux_last_cycle_8_dataout = '1'  ELSE first_nios2_system_cmd_xbar_mux_share_count_0_22q;
	wire_first_nios2_system_cmd_xbar_mux_share_count_19m_dataout <= wire_first_nios2_system_cmd_xbar_mux_share_count_17m_dataout AND NOT(wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout);
	wire_first_nios2_system_cmd_xbar_mux_share_count_zero_flag_18m_dataout <= wire_first_nios2_system_cmd_xbar_mux_p1_share_count_0_14m_w_lg_dataout21w(0) WHEN s_wire_first_nios2_system_cmd_xbar_mux_last_cycle_8_dataout = '1'  ELSE first_nios2_system_cmd_xbar_mux_share_count_zero_flag_30q;
	wire_first_nios2_system_cmd_xbar_mux_share_count_zero_flag_20m_dataout <= wire_first_nios2_system_cmd_xbar_mux_share_count_zero_flag_18m_dataout OR wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout;
	wire_first_nios2_system_cmd_xbar_mux_update_grant_27m_dataout <= (wire_nO_w22w(0) AND wire_w23w(0)) OR (s_wire_first_nios2_system_cmd_xbar_mux_last_cycle_8_dataout AND first_nios2_system_cmd_xbar_mux_share_count_zero_flag_30q);
	wire_first_nios2_system_cmd_xbar_mux_add0_13_a <= ( first_nios2_system_cmd_xbar_mux_share_count_0_22q & "1");
	wire_first_nios2_system_cmd_xbar_mux_add0_13_b <= ( "0" & "1");
	first_nios2_system_cmd_xbar_mux_add0_13 :  oper_add
	  GENERIC MAP (
	  ...
	  PORT MAP ( 
		a => wire_first_nios2_system_cmd_xbar_mux_add0_13_a,
		b => wire_first_nios2_system_cmd_xbar_mux_add0_13_b,
		cin => wire_gnd,
		o => wire_first_nios2_system_cmd_xbar_mux_add0_13_o
	  );

 END RTL; --first_nios2_system_cmd_xbar_mux
