...
alias com {
  ...
  vcom     "$QSYS_SIMDIR/submodules/first_nios2_system_led_pio.vhd"                                                                  -work led_pio                                                                 
