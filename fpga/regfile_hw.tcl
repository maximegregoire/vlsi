...
add_interface_port conduit_end T0INT_set export Input 1
add_interface_port conduit_end T1INT_set export Input 1
add_interface_port conduit_end T0CNT_in export Input 32
add_interface_port conduit_end T1CNT_in export Input 32
add_interface_port conduit_end avalon_inten export Input 1
...
add_interface_port interrupt_sender avalon_int irq Output 1
