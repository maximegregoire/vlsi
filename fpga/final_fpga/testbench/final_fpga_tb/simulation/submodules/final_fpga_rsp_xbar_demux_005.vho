...
--synthesis_resources = 
 ...
 ENTITY  final_fpga_rsp_xbar_demux_005 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END final_fpga_rsp_xbar_demux_005;

 ARCHITECTURE RTL OF final_fpga_rsp_xbar_demux_005 IS
 ...
 END RTL; --final_fpga_rsp_xbar_demux_005
