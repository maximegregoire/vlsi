...
--synthesis_resources = 
 ...
 ENTITY  final_fpga_id_router IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END final_fpga_id_router;

 ARCHITECTURE RTL OF final_fpga_id_router IS
	 ...
	 SIGNAL  s_wire_final_fpga_id_router_src_channel_1_332_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	wire_w334w(0) <= NOT s_wire_final_fpga_id_router_src_channel_1_332_dataout;
	wire_w_lg_w_sink_data_range298w348w(0) <= NOT wire_w_sink_data_range298w(0);
	s_wire_final_fpga_id_router_src_channel_1_332_dataout <= (wire_w_lg_w_sink_data_range295w349w(0) AND (NOT sink_data(100)));
	sink_ready <= src_ready;
	src_channel <= ( "0" & "0" & "0" & "0" & "0" & s_wire_final_fpga_id_router_src_channel_1_332_dataout & wire_w334w);
