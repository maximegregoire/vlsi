...
--synthesis_resources = 
 ...
 ENTITY  final_fpga_cmd_xbar_demux_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END final_fpga_cmd_xbar_demux_002;

 ARCHITECTURE RTL OF final_fpga_cmd_xbar_demux_002 IS
 ...
 END RTL; --final_fpga_cmd_xbar_demux_002
