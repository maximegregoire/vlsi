...
--synthesis_resources = 
 ...
 ENTITY  final_fpga_cmd_xbar_demux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
		 ...
		 src0_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 ...
		 src1_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 ...
		 src2_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 ...
		 src3_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 ...
		 src4_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 ...
		 src5_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 ...
		 src6_data	:	OUT  STD_LOGIC_VECTOR (110 DOWNTO 0);
		 src6_endofpacket	:	OUT  STD_LOGIC;
		 src6_ready	:	IN  STD_LOGIC;
		 src6_startofpacket	:	OUT  STD_LOGIC;
		 src6_valid	:	OUT  STD_LOGIC
	 ); 
 END final_fpga_cmd_xbar_demux;

 ARCHITECTURE RTL OF final_fpga_cmd_xbar_demux IS
	 ...
	 SIGNAL  s_wire_final_fpga_cmd_xbar_demux_wideor0_15_dataout :	STD_LOGIC;
 ...
 BEGIN
	...
	s_wire_final_fpga_cmd_xbar_demux_wideor0_15_dataout <= ((((((wire_w_lg_w_sink_channel_range1w2w(0) OR wire_w_lg_w_sink_channel_range3w4w(0)) OR wire_w_lg_w_sink_channel_range6w7w(0)) OR wire_w_lg_w_sink_channel_range9w10w(0)) OR wire_w_lg_w_sink_channel_range12w13w(0)) OR wire_w_lg_w_sink_channel_range15w16w(0)) OR wire_w_lg_w_sink_channel_range18w19w(0));
	sink_ready <= s_wire_final_fpga_cmd_xbar_demux_wideor0_15_dataout;
	src0_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src0_data <= ( sink_data(110 DOWNTO 0));
	src0_endofpacket <= sink_endofpacket;
	src0_startofpacket <= sink_startofpacket;
	src0_valid <= (sink_valid(0) AND sink_channel(0));
	src1_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src1_data <= ( sink_data(110 DOWNTO 0));
	src1_endofpacket <= sink_endofpacket;
	src1_startofpacket <= sink_startofpacket;
	src1_valid <= (sink_valid(0) AND sink_channel(1));
	src2_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src2_data <= ( sink_data(110 DOWNTO 0));
	src2_endofpacket <= sink_endofpacket;
	src2_startofpacket <= sink_startofpacket;
	src2_valid <= (sink_valid(0) AND sink_channel(2));
	src3_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src3_data <= ( sink_data(110 DOWNTO 0));
	src3_endofpacket <= sink_endofpacket;
	src3_startofpacket <= sink_startofpacket;
	src3_valid <= (sink_valid(0) AND sink_channel(3));
	src4_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src4_data <= ( sink_data(110 DOWNTO 0));
	src4_endofpacket <= sink_endofpacket;
	src4_startofpacket <= sink_startofpacket;
	src4_valid <= (sink_valid(0) AND sink_channel(4));
	src5_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src5_data <= ( sink_data(110 DOWNTO 0));
	src5_endofpacket <= sink_endofpacket;
	src5_startofpacket <= sink_startofpacket;
	src5_valid <= (sink_valid(0) AND sink_channel(5));
	src6_channel <= ( "0" & "0" & "0" & "0" & "0" & "0" & "0");
	src6_data <= ( sink_data(110 DOWNTO 0));
 ...
 END RTL; --final_fpga_cmd_xbar_demux
