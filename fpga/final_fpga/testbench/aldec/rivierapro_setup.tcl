...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_width_adapter.sv"                                                                  -work width_adapter                                                                 
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_address_alignment.sv"                                                              -work width_adapter                                                                 
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                             -work width_adapter                                                                 
  ...
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_reset_controller.v"                                                                       -work rst_controller                                                                
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_reset_synchronizer.v"                                                                     -work rst_controller                                                                
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_burst_adapter.sv"                                                                  -work burst_adapter                                                                 
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_address_alignment.sv"                                                              -work burst_adapter                                                                 
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_traffic_limiter.sv"                                                                -work limiter                                                                       
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_avalon_st_pipeline_base.v"                                                                -work limiter                                                                       
  ...
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_slave_agent.sv"                                                                    -work cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent               
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_burst_uncompressor.sv"                                                             -work cpu_jtag_debug_module_translator_avalon_universal_slave_0_agent               
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_master_agent.sv"                                                                   -work cpu_data_master_translator_avalon_universal_master_0_agent                    
  ...
  vlog  "$QSYS_SIMDIR/first_nios2_system_tb/simulation/submodules/aldec/altera_merlin_master_translator.sv"                                                              -work cpu_data_master_translator                                                    
