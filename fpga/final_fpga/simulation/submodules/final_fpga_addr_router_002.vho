...
--synthesis_resources = 
 ...
 ENTITY  final_fpga_addr_router_002 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END final_fpga_addr_router_002;

 ARCHITECTURE RTL OF final_fpga_addr_router_002 IS
 ...
 BEGIN
	...
	src_data <= ( sink_data(92 DOWNTO 83) & "0" & "1" & "0" & sink_data(79 DOWNTO 0));
	src_endofpacket <= sink_endofpacket;
	src_startofpacket <= sink_startofpacket;
	src_valid <= sink_valid;

 END RTL; --final_fpga_addr_router_002
