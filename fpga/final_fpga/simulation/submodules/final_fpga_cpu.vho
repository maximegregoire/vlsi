...
--synthesis_resources = altera_std_synchronizer 1 altsyncram 5 final_fpga_cpu_jtag_debug_module_wrapper 1 final_fpga_cpu_mult_cell 1 final_fpga_cpu_oci_test_bench 1 final_fpga_cpu_test_bench 1 lut 1331 mux21 1913 oper_add 14 oper_less_than 6 
 LIBRARY ieee;
...
component final_fpga_cpu_test_bench is 
	 ...
	 SIGNAL  wire_the_final_fpga_cpu_test_bench_w_lg_E_src1_eq_src21213w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
 ...
 BEGIN
	...
	wire_the_final_fpga_cpu_test_bench_w_lg_E_src1_eq_src21213w(0) <= NOT wire_the_final_fpga_cpu_test_bench_E_src1_eq_src2;
	...
	wire_n00OlO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(0) WHEN ni0Oi0l = '1'  ELSE wire_n0i0Ol_dataout;
	wire_n00OO_dataout <= nll11O WHEN nii10ii = '1'  ELSE n01iO;
	wire_n00OOi_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(1) WHEN ni0Oi0l = '1'  ELSE wire_n0i0OO_dataout;
	wire_n00OOl_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(2) WHEN ni0Oi0l = '1'  ELSE wire_n0ii1i_dataout;
	wire_n00OOO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(3) WHEN ni0Oi0l = '1'  ELSE wire_n0ii1l_dataout;
	...
	wire_n0i00i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(22) WHEN ni0Oi0l = '1'  ELSE wire_n0il0O_dataout;
	wire_n0i00l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(23) WHEN ni0Oi0l = '1'  ELSE wire_n0ilii_dataout;
	wire_n0i00O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(24) WHEN ni0Oi0l = '1'  ELSE wire_n0ilil_dataout;
	wire_n0i01i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(19) WHEN ni0Oi0l = '1'  ELSE wire_n0il1O_dataout;
	wire_n0i01l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(20) WHEN ni0Oi0l = '1'  ELSE wire_n0il0i_dataout;
	wire_n0i01O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(21) WHEN ni0Oi0l = '1'  ELSE wire_n0il0l_dataout;
	...
	wire_n0i0ii_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(25) WHEN ni0Oi0l = '1'  ELSE wire_n0iliO_dataout;
	wire_n0i0il_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(26) WHEN ni0Oi0l = '1'  ELSE wire_n0illi_dataout;
	wire_n0i0iO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(27) WHEN ni0Oi0l = '1'  ELSE wire_n0illl_dataout;
	wire_n0i0li_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(28) WHEN ni0Oi0l = '1'  ELSE wire_n0illO_dataout;
	wire_n0i0ll_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(29) WHEN ni0Oi0l = '1'  ELSE wire_n0ilOi_dataout;
	wire_n0i0lO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(30) WHEN ni0Oi0l = '1'  ELSE wire_n0ilOl_dataout;
	wire_n0i0Oi_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(31) WHEN ni0Oi0l = '1'  ELSE wire_n0ilOO_dataout;
	...
	wire_n0i10i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(7) WHEN ni0Oi0l = '1'  ELSE wire_n0ii0O_dataout;
	wire_n0i10l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(8) WHEN ni0Oi0l = '1'  ELSE wire_n0iiii_dataout;
	wire_n0i10O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(9) WHEN ni0Oi0l = '1'  ELSE wire_n0iiil_dataout;
	wire_n0i11i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(4) WHEN ni0Oi0l = '1'  ELSE wire_n0ii1O_dataout;
	wire_n0i11l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(5) WHEN ni0Oi0l = '1'  ELSE wire_n0ii0i_dataout;
	wire_n0i11O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(6) WHEN ni0Oi0l = '1'  ELSE wire_n0ii0l_dataout;
	wire_n0i1ii_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(10) WHEN ni0Oi0l = '1'  ELSE wire_n0iiiO_dataout;
	wire_n0i1il_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(11) WHEN ni0Oi0l = '1'  ELSE wire_n0iili_dataout;
	wire_n0i1iO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(12) WHEN ni0Oi0l = '1'  ELSE wire_n0iill_dataout;
	wire_n0i1l_dataout <= n101O WHEN n1l0l = '1'  ELSE wire_n0i0l_o(0);
	wire_n0i1l_w_lg_dataout2694w(0) <= NOT wire_n0i1l_dataout;
	wire_n0i1li_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(13) WHEN ni0Oi0l = '1'  ELSE wire_n0iilO_dataout;
	wire_n0i1ll_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(14) WHEN ni0Oi0l = '1'  ELSE wire_n0iiOi_dataout;
	wire_n0i1lO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(15) WHEN ni0Oi0l = '1'  ELSE wire_n0iiOl_dataout;
	wire_n0i1O_dataout <= n100i WHEN n1l0l = '1'  ELSE wire_n0i0l_o(1);
	wire_n0i1O_w_lg_dataout2692w(0) <= NOT wire_n0i1O_dataout;
	wire_n0i1Oi_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(16) WHEN ni0Oi0l = '1'  ELSE wire_n0iiOO_dataout;
	wire_n0i1Ol_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(17) WHEN ni0Oi0l = '1'  ELSE wire_n0il1i_dataout;
	wire_n0i1OO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(18) WHEN ni0Oi0l = '1'  ELSE wire_n0il1l_dataout;
	...
	wire_n0iO0i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(3) WHEN ni0Oili = '1'  ELSE wire_n0l00O_dataout;
	wire_n0iO0l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(4) WHEN ni0Oili = '1'  ELSE wire_n0l0ii_dataout;
	wire_n0iO0O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(5) WHEN ni0Oili = '1'  ELSE wire_n0l0il_dataout;
	wire_n0iO1i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(0) WHEN ni0Oili = '1'  ELSE wire_n0l01O_dataout;
	wire_n0iO1l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(1) WHEN ni0Oili = '1'  ELSE wire_n0l00i_dataout;
	wire_n0iO1O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(2) WHEN ni0Oili = '1'  ELSE wire_n0l00l_dataout;
	wire_n0iOii_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(6) WHEN ni0Oili = '1'  ELSE wire_n0l0iO_dataout;
	wire_n0iOil_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(7) WHEN ni0Oili = '1'  ELSE wire_n0l0li_dataout;
	wire_n0iOiO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(8) WHEN ni0Oili = '1'  ELSE wire_n0l0ll_dataout;
	wire_n0iOli_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(9) WHEN ni0Oili = '1'  ELSE wire_n0l0lO_dataout;
	wire_n0iOll_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(10) WHEN ni0Oili = '1'  ELSE wire_n0l0Oi_dataout;
	wire_n0iOlO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(11) WHEN ni0Oili = '1'  ELSE wire_n0l0Ol_dataout;
	wire_n0iOOi_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(12) WHEN ni0Oili = '1'  ELSE wire_n0l0OO_dataout;
	wire_n0iOOl_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(13) WHEN ni0Oili = '1'  ELSE wire_n0li1i_dataout;
	wire_n0iOOO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(14) WHEN ni0Oili = '1'  ELSE wire_n0li1l_dataout;
	...
	wire_n0l01i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(30) WHEN ni0Oili = '1'  ELSE wire_n0ll1O_dataout;
	wire_n0l01l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(31) WHEN ni0Oili = '1'  ELSE wire_n0ll0i_dataout;
	...
	wire_n0l10i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(18) WHEN ni0Oili = '1'  ELSE wire_n0li0O_dataout;
	wire_n0l10l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(19) WHEN ni0Oili = '1'  ELSE wire_n0liii_dataout;
	wire_n0l10O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(20) WHEN ni0Oili = '1'  ELSE wire_n0liil_dataout;
	wire_n0l11i_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(15) WHEN ni0Oili = '1'  ELSE wire_n0li1O_dataout;
	wire_n0l11l_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(16) WHEN ni0Oili = '1'  ELSE wire_n0li0i_dataout;
	wire_n0l11O_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(17) WHEN ni0Oili = '1'  ELSE wire_n0li0l_dataout;
	wire_n0l1ii_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(21) WHEN ni0Oili = '1'  ELSE wire_n0liiO_dataout;
	wire_n0l1il_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(22) WHEN ni0Oili = '1'  ELSE wire_n0lili_dataout;
	wire_n0l1iO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(23) WHEN ni0Oili = '1'  ELSE wire_n0lill_dataout;
	wire_n0l1li_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(24) WHEN ni0Oili = '1'  ELSE wire_n0lilO_dataout;
	wire_n0l1ll_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(25) WHEN ni0Oili = '1'  ELSE wire_n0liOi_dataout;
	wire_n0l1lO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(26) WHEN ni0Oili = '1'  ELSE wire_n0liOl_dataout;
	wire_n0l1Oi_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(27) WHEN ni0Oili = '1'  ELSE wire_n0liOO_dataout;
	wire_n0l1Ol_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(28) WHEN ni0Oili = '1'  ELSE wire_n0ll1i_dataout;
	wire_n0l1OO_dataout <= wire_the_final_fpga_cpu_test_bench_M_wr_data_filtered(29) WHEN ni0Oili = '1'  ELSE wire_n0ll1l_dataout;
	...
	wire_n111li_dataout <= wire_the_final_fpga_cpu_test_bench_E_src1_eq_src2 WHEN (wire_nl1ll_w_lg_n1l01l1217w(0) AND wire_nl1ll_w_lg_nlOi1iO1214w(0)) = '1'  ELSE wire_n111ll_dataout;
	...
	wire_n111lO_dataout <= wire_n1l1lO_dataout WHEN (n1l01l AND wire_nl1ll_w_lg_nlOi1iO1214w(0)) = '1'  ELSE wire_the_final_fpga_cpu_test_bench_w_lg_E_src1_eq_src21213w(0);
