...
--synthesis_resources = 
 ...
 ENTITY  final_fpga_cmd_xbar_demux_001 IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END final_fpga_cmd_xbar_demux_001;

 ARCHITECTURE RTL OF final_fpga_cmd_xbar_demux_001 IS
	 ...
	 SIGNAL  s_wire_final_fpga_cmd_xbar_demux_001_wideor0_15_dataout :	STD_LOGIC;
 ...
 END RTL; --final_fpga_cmd_xbar_demux_001
